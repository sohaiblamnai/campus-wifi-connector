# 🛜 Campus Connectee- Auto Login

A lightweight and secure automation script to instantly connect to the **Campus Connectee** WiFi network across all public universities in Morocco.
